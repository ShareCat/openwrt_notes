...
dl_url="https://dl.muyii.cn/amlogic"
...
dlfile="amlogic-backup-32.gz"

printStr yellow "下载刷机包...移动网速度稍慢，电信和联通速度很快"
wget -q --show-progress --no-check-certificate ${dl_url}/${dlfile} -O /backupbox/${dlfile} || _exit 1 "下载失败，请重试"
printStr yellow "校验刷机包..."
[ "$(get_md5 -c ${dl_url}/${dlfile}.md5sum ${dlfile})" != "$(get_md5 -l /backupbox/${dlfile})" ] && _exit 1 "文件校验失败，请重试"
printStr green "下载完成！"
recoverbackup
